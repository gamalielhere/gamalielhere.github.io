      ...
      <div className={className("pageContainer", classes.root)}>
        <div className={classes.rootItem}>
          ...
          <Typography variant="subheading" component="p" align="center">
            ...
            diverse skill set and creative drive to software development.
          </Typography>
          <div className={classes.imgContainer}>
            <img
              title="Gamaliel Padillo vanity shot"
              alt="Gamaliel Padillo vanity shot"
              src={mypic}
          ...
          <div className={classes.greetingContainer}>
            <div className={classes.greeting}>
              <Typography variant="body1" component="p">
                Hey there! I am Gamaliel, Yel for short. I'm a software
                developer with a passion for creating and learning new things. I
                believe that no one really stops learning - so we should all
                strive to learn something new everyday! When I'm not trying to
                learn something, I'm usually programming. It could be for this
                website, or anything else. I try to program everyday if
                possible.
                <br />
                <br />I have more projects in the making so stay tuned!
              </Typography>
            </div>
